...
def generate_demo_data():
    ...
    sample_users = [
        ("foodie_explorer", "Sarah Johnson", "Food & Travel Blogger 🍽️✈️", 45000, 1200),
    ...
    dataset = {
        ...
        'users': users[1:],  # Exclude target user from network users
        'posts': posts,
        'likes': likes
    }
    ...
    with open('sample_data/mock_instagram_data.json', 'w') as f:
